...
public class BuyMedicineBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edname = findViewById(R.id.editTextLTBRegUsernameBMB);
        edaddress = findViewById(R.id.editTextLTBAddressBMB);
        edcontact = findViewById(R.id.editTextLTBContactNumberBMB);
        edpincode = findViewById(R.id.editTextLTBPinCodeBMB);
        btnBooking = findViewById(R.id.buttonLTBBookBMB);
