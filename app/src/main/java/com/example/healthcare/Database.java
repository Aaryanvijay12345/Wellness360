...
public class Database extends SQLiteOpenHelper {
    ...
    public void addOrder(String username, String fullname, String contact, String address, int pincode, String date, String s, float price, String otype){
        ContentValues cv = new ContentValues();
        cv.put("username", username);
